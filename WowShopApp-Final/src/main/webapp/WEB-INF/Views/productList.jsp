                 ...
                 <tbody>
                         ...
                         <td>
                          ...
                          <td>${p.category.categoryname}</td>     
                           ...
                           <td>${p.price}</td> 
                           <td> 
                           <%-- <img src='<c:url value="./resources/product/${p.pimage}" />'class="img-rounded" alt="${p.pname }" width="75px" height="50px"/> --%>
                           
                           <img id="item-display" src="<c:url value='/resources/product/${p.pimage}' />" alt="" width="75px" height="50px"></img>
