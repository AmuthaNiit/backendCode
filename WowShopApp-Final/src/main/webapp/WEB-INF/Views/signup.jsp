	...
	<body>
		<div class="container">
			<div class="row main">
				...
				<h5>Sign up</h5>
					<form Id="userform" class="userForm" method="post" action="reg">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="number" class="form-control" name="phno" id="phno"  placeholder="Enter your phone number"   maxlength="10"  pattern="[0-9]{10}" Required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="textarea" class="form-control" name="address" id="address"  placeholder="Enter your address" Required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group ">
                            ...
                            <button id="reset" name="reset" value="reset" class="btn btn-primary" onclick="Reset()">Cancel</button>
						</div>
